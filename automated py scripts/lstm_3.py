...
Original file is located at
    https://colab.research.google.com/drive/1sTLE06FdG-TaTkxX6OjG8qGqZZKMJ_mL
"""
...
for i in range(1,32,2):
    ...
    model_lstm.add(LSTM(100, activation='softsign', input_shape=(x_train.shape[1],x_train.shape[2])))
    model_lstm.add(Dense(1))
    model_lstm.compile(loss='mean_absolute_error', optimizer='adam')
    model_lstm.summary()

    lstm_history = model_lstm.fit(x_train, y_train, epochs = 200,batch_size = 32, verbose=1,validation_data=(x_val, y_val))
