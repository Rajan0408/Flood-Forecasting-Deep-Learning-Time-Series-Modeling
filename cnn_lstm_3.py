...
Original file is located at
    https://colab.research.google.com/drive/1sZUm2BuOSeVezlEZ_92XeQ6hGwJhtc9o
"""
...
for i in range(1,32,2):
    ...
    history = model.fit(x_train.reshape(len(x_train), 1, x_train.shape[2], 1) ,y_train, batch_size=64, epochs=100, verbose=1,validation_data=(x_val, y_val))
    ...
    res.to_csv(str(i)+'cnn_lstm.csv')

from google.colab import files
#import pandas as pd
#result.to_csv('example_file.csv')
for i in range(1,32,2):
  files.download(str(i)+'cnn_lstm.csv')
